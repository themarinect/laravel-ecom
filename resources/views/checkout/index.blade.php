            ...
            <form action="{{url('/submit-checkout')}}" method="post" class="form-horizontal">
                <div class="col-sm-4 col-sm-offset-1">
                    ...
                    <div class="login-form">
                        ...
                        <div class="form-group {{$errors->has('billing_zipcode')?'has-error':''}}">
                            <input type="text" class="form-control" name="billing_zipcode" value="{{$user_login->pincode}}" id="billing_zipcode" placeholder=" Billing Zipcode">
                            <span class="text-danger">{{$errors->first('billing_zipcode')}}</span>
                        </div>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="signup-form">
                        ...
                        <div class="form-group {{$errors->has('shipping_zipcode')?'has-error':''}}">
                            <input type="text" class="form-control" name="shipping_zipcode" value="" id="shipping_zipcode" placeholder="Shipping Zipcode">
                            <span class="text-danger">{{$errors->first('shipping_zipcode')}}</span>
                        </div>
